...
%%%%% end titlepage extension code\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, boxrule=0pt, breakable, sharp corners, enhanced, borderline west={3pt}{0pt}{shadecolor}, interior hidden]}{\end{tcolorbox}}\fi
...
\hypertarget{eastern-bering-sea-slope-bss-rn979}{%
\section{\texorpdfstring{\textbf{Eastern Bering Sea Slope (BSS)} (Hoff,
2016)}{Eastern Bering Sea Slope (BSS) (Hoff, 2016)}}\label{eastern-bering-sea-slope-bss-rn979}}
...
\section{\texorpdfstring{\textbf{Eastern Bering Sea Shelf (EBS)}
(Markowitz et al.,
...
\section{\texorpdfstring{\textbf{Northern Bering Sea (NBS)} (Markowitz
et al.,
