...
\begin{quote}
Report run date: Sunday, January 12, 2025
\end{quote}
...
restrictions on access to the data. Last updated on 11 December 2024.
...
no legal restrictions on access to the data. Last updated on 11 December
2024.
...
Non-zero catch records from RACEBASE.CATCH subsetted for standard GAP
bottom trawl stations (i.e., HAULJOIN values associated with
ABUNDANCE\_HAUL = Y in RACEBASE.HAUL). This table was created by the
