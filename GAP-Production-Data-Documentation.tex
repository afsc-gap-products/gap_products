...
%%%%% end titlepage extension code\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, borderline west={3pt}{0pt}{shadecolor}, interior hidden, boxrule=0pt, sharp corners, enhanced, frame hidden]}{\end{tcolorbox}}\fi
...
\addcontentsline{toc}{section}{Annual Publications}

\markright{Annual Publications}

\hypertarget{annual-data-report-tech-memos}{%
\subsection*{Annual Data Report Tech
Memos}\label{annual-data-report-tech-memos}}
\addcontentsline{toc}{subsection}{Annual Data Report Tech Memos}
...
\addcontentsline{toc}{subsection}{Community Highlights}
...
\addcontentsline{toc}{subsection}{North Pacific Groundfish Plan Team}
...
\addcontentsline{toc}{subsection}{Code Books}
...
\addcontentsline{toc}{subsection}{Survey Protocols}
...
\addcontentsline{toc}{section}{NOAA Fisheries Distribution Mapping and
Analysis Portal (DisMAP)}

\markright{NOAA Fisheries Distribution Mapping and Analysis Portal
(DisMAP)}
...
\addcontentsline{toc}{section}{Collaborators}

\markright{Collaborators}
