...
%%%%% end titlepage extension code\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, enhanced, sharp corners, boxrule=0pt, interior hidden, borderline west={3pt}{0pt}{shadecolor}, frame hidden]}{\end{tcolorbox}}\fi
...
\begin{Highlighting}[]
\CommentTok{{-}{-} old}
\CommentTok{{-}{-} SELECT * FROM GAP\_PRODUCTS.JOIN\_FOSS\_CPUE\_HAUL}
\CommentTok{{-}{-} FULL JOIN GAP\_PRODUCTS.JOIN\_FOSS\_CPUE\_CATCH}
\CommentTok{{-}{-} ON GAP\_PRODUCTS.JOIN\_FOSS\_CPUE\_HAUL.HAULJOIN = GAP\_PRODUCTS.JOIN\_FOSS\_CPUE\_CATCH.HAULJOIN;}
\CommentTok{{-}{-} When zero{-}filled data are available on }
...
\NormalTok{cc.TAXON\_CONFIDENCE,}
\NormalTok{cc.WEIGHT\_KG,}
\NormalTok{cc.}\FunctionTok{COUNT}\NormalTok{,}
\NormalTok{cc.CPUE\_KGKM2,}
\NormalTok{cc.CPUE\_NOKM2,}
...
\KeywordTok{FROM}\NormalTok{ GAP\_PRODUCTS.FOSS\_CATCH cc}
\KeywordTok{LEFT} \KeywordTok{JOIN}\NormalTok{ GAP\_PRODUCTS.FOSS\_HAUL hh}
\KeywordTok{ON}\NormalTok{ cc.HAULJOIN }\OperatorTok{=}\NormalTok{ hh.HAULJOIN}
\KeywordTok{FULL} \KeywordTok{JOIN}\NormalTok{ GAP\_PRODUCTS.FOSS\_SPECIES\_TEST ss}
\KeywordTok{ON}\NormalTok{ cc.SPECIES\_CODE }\OperatorTok{=}\NormalTok{ ss.SPECIES\_CODE}
\end{Highlighting}
\end{Shaded}
