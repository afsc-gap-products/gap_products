...
\begin{Highlighting}[]
\NormalTok{dat }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{()}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \FunctionTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{100000}\NormalTok{, }\DecValTok{10000}\NormalTok{))\{}
\CommentTok{\# for (i in seq(0, 1000000, 10000))\{}
  \DocumentationTok{\#\# find how many iterations it takes to cycle through the data}
  \FunctionTok{print}\NormalTok{(i)}
  \DocumentationTok{\#\# query the API link}
...
\begin{verbatim}
 ...
 Min.   : -23125   Min.   :    1   Min.   :      0.0   Min.   :     15  
 1st Qu.: -14038   1st Qu.:21341   1st Qu.:      4.7   1st Qu.:     56  
 Median :  -5443   Median :43021   Median :     40.4   Median :    210  
 Mean   : 282737   Mean   :47860   Mean   :   1106.3   Mean   :   4501  
 3rd Qu.: 816038   3rd Qu.:72751   3rd Qu.:    317.1   3rd Qu.:   1098  
 Max.   :1225635   Max.   :99999   Max.   :2320530.9   Max.   :5084865  
                                                       NA's   :13864    
     count            weight_kg         taxon_confidence  
 Min.   :     1.0   Min.   :    0.001   Length:110000     
 1st Qu.:     2.0   1st Qu.:    0.168   Class :character  
 Median :     8.0   Median :    1.492   Mode  :character  
 Mean   :   179.3   Mean   :   37.856                     
 3rd Qu.:    42.0   3rd Qu.:   11.860                     
 Max.   :198631.0   Max.   :18187.700                     
 NA's   :13864                                            
\end{verbatim}
