...
%%%%% end titlepage extension code\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, sharp corners, frame hidden, interior hidden, borderline west={3pt}{0pt}{shadecolor}, enhanced, breakable]}{\end{tcolorbox}}\fi
...
{\centering \includegraphics[width=13.89in,height=8.76in]{content/intro-workflow_files/figure-latex/mermaid-figure-1.png}
