---
title: '`r ifelse(tocTF, "", "AFSC RACE Groundfish and Shellfish Assessment Program Design-Based Production Data")`'
output: 
  md_document: 
    variant: gfm
...
```{r child-footer, child=here::here("docs","footer.Rmd"), echo=tocTF, eval=tocTF}
```
