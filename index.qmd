...
> Please consider this resource to be a **Living Document**. The code in this repository is regularly being updated and improved. Please refer to [releases](%60r%20paste0(link_repo,%20'/releases')%60) for finalized products and project milestones.
...
(@) **Index Computation Working Group:** consolidation of the methods used to produced design-based estimates of abundance and size/age composition between the Bering Sea and AIGOA survey regions.
