...
```{r g, message = TRUE, comment = TRUE, warning = TRUE, eval = eval0}
...
```{r ggg, message = TRUE, comment = TRUE, warning = TRUE, eval = eval0}
dat <- comb |>
  # add species data
...
```{r j, fig.height=8, fig.width=6, eval = eval0}
