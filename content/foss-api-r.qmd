...
```{r api_link_haul-test, echo = FALSE, eval = test0}
...
```{r b, echo = FALSE}
#| label: print-haul
#| tbl-cap: "First few rows of haul data. "
...
pretty_print_haul(dat0 = head(dat, 3))
```
...
```{r api_link_catch-test, echo = FALSE, eval = test0}
...
```{r d, echo = FALSE}
#| label: print-catch
#| tbl-cap: "First few rows of catch data. "
...
pretty_print_catch(dat0 = head(dat_catch_api, 3))
```
...
```{r api_link_species-test, echo = FALSE, eval = test0}
...
```{r f, echo = FALSE}
#| label: print-species
#| tbl-cap: "First few rows of species data. "
...
pretty_print_species(dat0 = head(data$items, 3))
```
...
#| tbl-cap: "CPUE (kg/km^2) of walleye pollock catch at each station in the 2023 eastern Bering Sea bottom trawl survey. Red triangles denote stations where walleye pollock were not caught. "
...
#| tbl-cap: "CPUE of walleye pollock catch at each station in the 2023 eastern Bering Sea bottom trawl survey. "
...
# Print the first few lines of the data, but make it pretty for quarto
pretty_print_haul(dat0 = head(dat_haul_ex, 3))
```
...
# Print the first few lines of the data, but make it pretty for quarto
pretty_print_species(dat0 = dat_species_ex)
```
...
```{r t, echo = FALSE}
#| label: print-catch-2023
#| tbl-cap: "Catch data for all 2023 eastern Bering Sea Walleye Pollock. "

pretty_print_catch(dat0 = head(dat, 3))
```
...
#| tbl-cap: "Amount of catch at each station in the 2023 eastern Bering Sea bottom trawl survey. Red triangles denote stations where walleye pollock were not caught. "
...
```{r ff, eval = FALSE, include = FALSE, echo = FALSE}
summary(dat)
...
```{r dd, eval = FALSE, include = FALSE, echo = FALSE}
# Print the first few lines of the data 
head(dat, 3)
```

```{r ee, echo = FALSE, include = FALSE, echo = FALSE}
#| label: test-foss-api-6
#| tbl-cap: 'Haul data where year is less than 1989, srvy is "EBS", and stratum is not equal to 81.'
