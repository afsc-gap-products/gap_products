...
```{r}
#| label: test-foss-api-1
#| tbl-cap: "Load the first 25 rows (default) of data. "
...
## Ex. Load the first 10000 rows of data

```{r}
#| label: test-foss-api-2
#| tbl-cap: "Load the first 10000 rows of data. "
...
```{r}
#| label: test-foss-api-4
#| tbl-cap: "Filter by species name. "
...
```{r}
#| label: test-foss-api-5
#| tbl-cap: "Combination of year and name filters. "
...
#| tbl-cap: "Combination of year, srvy, stratum. "
...
```{r}
#| label: test-foss-api-7
#| tbl-cap: "Visualize CPUE data in distribution map. "
...
```{r}
#| label: test-foss-api-7-fig
#| fig-cap: "Visualize CPUE data in distribution map. "
#| message: false
#| warning: false
