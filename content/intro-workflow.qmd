...
flowchart LR
  A[On vessel\nCatch data tablet] --> B(METIS)
  A[On vessel\nLength data tablets] --> B(METIS)
  A[On vessel\nSpecimen data tablet] --> B(METIS)
  A[On vessel\nWheelhouse haul data] --> C(GIDES and RACE EDIT_* tables in Oracle)
  B --> C
  C --> D[RACEBASE Oracle schema]
  D --> E[gapindex R package and gap_products R scripts]
