...
Use the below [bibtext citations](`r paste0(link_repo, "/blob/main/code/CITATION_FOSSAFSCData.bib")`), as cited in our group's [citation repository](https://github.com/afsc-gap-products/citations/blob/main/cite/bibliography.bib) for citing the data created and maintained in this repo [@FOSSAFSCData]. Add "note = {Accessed: mm/dd/yyyy}" to append the day this data was accessed. 

```{r load_citation, echo = FALSE}
cat(readLines(con = here::here("code", "CITATION_FOSSAFSCData.bib")), sep = "\n") 
```
