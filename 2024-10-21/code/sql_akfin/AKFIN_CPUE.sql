-- SQL Command to Create Materilized View GAP_PRODUCTS.AKFIN_CPUE
--
-- Created by copying GAP_PRODUCTS.CPUE table to a materialized view 
-- for AKFIN and does not have any other object dependencies. 
-- GAP_PRODUCTS.CPUE is generated in the gap_products GitHub repo 
