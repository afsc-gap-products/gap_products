...
%%%%% end titlepage extension code\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}, sharp corners, breakable, frame hidden, interior hidden]}{\end{tcolorbox}}\fi
...
\begin{quote}
Report run date: Wednesday, April 23, 2025
\end{quote}
...
\begin{longtable}[c]{|p{1.50in}
\caption{Survey summary stats}\tabularnewline
|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}}
...
|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}}
...
\begin{longtable}[c]{|p{0.75in}
\caption{EBS Pacific Ocean perch CPUE and akgfmaps map.}\tabularnewline
|p{0.75in}|p{0.75in}}
...
\hypertarget{access-api-data-via-r}{%
...
\hypertarget{ex.-direct-database-query-in-r-using-the-akfingapdata-r-package-readme}{%
...
\hypertarget{load-first-25-rows-of-data}{%
...
\hypertarget{load-first-25-rows-of-data-1}{%
\subsubsection{Load first 25 rows of
...
\hypertarget{ex.-create-zero-filled-data-using-data-loaded-in-last-example}{%
...
\hypertarget{ex.-visualize-zero-filled-data-for-2023-eastern-bering-sea-walleye-pollock-in-cpue-data-in-distribution-map}{%
...
\hypertarget{plot-locations-on-map}{%
...
\hypertarget{plot-inverse-distance-weighted-plot-of-cpue}{%
...
\hypertarget{ex.-show-catch-data-for-2023-eastern-bering-sea-walleye-pollock-one-species-in-one-survey-region-in-one-year}{%
...
\begin{longtable}[c]{|p{0.75in}
\caption{Haul data filtered by year = 2023 and SRVY =
\textquotesingle EBS\textquotesingle.}\tabularnewline
|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}}
...
|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}|p{0.75in}}
...
\hypertarget{access-via-oracle-and-r-afsc-staff-only}{%
...
\begin{longtable}[c]{|p{2.00in}
\caption{Survey of products developed by GAP}\tabularnewline
|p{1.50in}|p{1.50in}|p{1.50in}|p{3.00in}}
...
loaded via a namespace (and not attached):
 ...
 [9] knitr_1.50        xfun_0.52         digest_0.6.37     jsonlite_2.0.0   
