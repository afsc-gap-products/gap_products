...
drop table biomass_ebs_standard_grouped ;
create table biomass_ebs_standard_grouped
...
insert into biomass_ebs_standard_grouped
...
grant select on biomass_ebs_standard_grouped to public;
commit;
...
DEGREEFNUM,HAULCOUNT,CATCOUNT,NUMCOUNT,LENCOUNT  
from biomass_ebs_standard_grouped order by species_code, year, stratum;
