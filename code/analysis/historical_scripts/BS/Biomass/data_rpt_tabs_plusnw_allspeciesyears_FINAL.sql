...
REM MODIFIED 09/09/2022 UPDATED RACEBASE.STRATUM CALLS TO AREAS CALCULATED IN 2022
...
drop table biomass_ebs_plusnw ;
create table biomass_ebs_plusnw 
...
insert into biomass_ebs_plusnw 
...
delete from biomass_ebs_plusnw where year <=1986;

drop table temp_biomass;

grant select on biomass_ebs_plusnw to public;
commit;

select * from biomass_ebs_plusnw order by species_code, year, stratum;
